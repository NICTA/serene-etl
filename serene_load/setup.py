...
setup(
    name='serene_load',
    version=version,
    description='Serene Scanner and Loader',
    ...
    entry_points={
        'console_scripts': [
            'serene_scan=serene_load.scan:main',
            'serene_load=serene_load.load:main',
            'serene_dir_wrapper=serene_load.dir_wrapper:main',
            'serene_merge_trees=serene_load.merge_trees:main',
            'serene_meta_select=serene_load.meta_select:main'
        ]
    },
